...
const MenuManagement = () => {
    ...
    // Categories for filtering - updated to match database schema
    const categories = ['All Items', 'Starter', 'Main Course', 'Dessert', 'Beverages'];
                                ...
                                {filteredItems.map(item => (
                                    <div key={item.id} className="menu-item-card">
                                        ...
                                        <div className="item-details">
                                            ...
                                            <div className="item-type-tags">
                                                <span className={`veg-indicator ${item.is_veg ? 'veg' : 'non-veg'}`}>
                                                    <span className="dot"></span>
                                                </span>
                                                <span className="dish-tag">{item.dish_tag}</span>
                                                <span className={`category-tag category-${item.dish_category.toLowerCase().replace(/\s+/g, '-')}`}>{item.dish_category}</span>
                                            </div>
                                            ...
                                            <div className="item-footer">
                                                <span className="item-price">
                                                    {item.discount > 0 && (
                                                        <span className="original-price">₹{item.price.toFixed(0)}</span>
                                                    )}
