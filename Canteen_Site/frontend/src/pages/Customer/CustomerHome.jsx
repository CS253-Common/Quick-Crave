...
const CustomerHome = () => {
    ...
    // Fetch Cart Items and save to session storage
    const fetchCart = async() => {
        try {
            const cartItems = await axios.post('http://localhost:4000/customer/customer-view-cart'); 
            sessionStorage.setItem('cartItems', cartItems.data);
            console.log("CART : ", cartItems.data) ; 

            //set total items as cartItems ka length
            const lengthhai = cartItems.data.dishes.length;
            ...
            <div className="main-content">
              ...
              <div className="logo-container">
                ...
                <div className="service-cards">
                    <Link to="/food-canteen-listing" className="service-card">
                ...
                <div className="favourite-items">
                    {
                        ...
                        <Link to="/canteen-details" key={item.canteen_name} className="favourite-item">
