...
const canteenService = {
  ...
  getActiveDiscounts: async () => {
    try {
      const response = await axios.get(`${API_URL}/canteen/active-discounts`);
      console.log('Active discounts:', response.data);
      return response.data;
    } catch (error) {
  ...
  deleteDiscount: async (discountId) => {
    try {
      const response = await axios.post(`${API_URL}/canteen/delete-discount`, {dishId: discountId});
  ...
  deleteCoupon: async (couponId) => {
    try {
      const response = await axios.post(`${API_URL}/canteen/delete-coupon`, {couponId: couponId});
  ...
  addMenuItem: async (menuItemData) => {
    try {
      ...
      const apiData = {
        ...
        category_tag: menuItemData.category_tag,
      ...
      if (menuItemData.imageFile) {
        ...
        const response = await axios.post(`${API_URL}/canteen/menu-items/add`, formData);

        console.log('Menu item added successfully:', response.data);
        return response.data;
      } 
      else {
        const response = await axios.post(`${API_URL}/canteen/menu-items/add`, apiData);
  ...
  updateMenuItem: async (itemId, menuItemData) => {
    try {
      ...
      if (menuItemData.imageFile) {
        ...
        const response = await axios.post(`${API_URL}/canteen/menu-items/update/${itemId}`, formData, {
          headers: { 
        ...
        const response = await axios.post(`${API_URL}/canteen/menu-items/update/${itemId}`, apiData, {
          headers: { 
  ...
  getUserProfile: async () => {
    try {
        ...
        return {
            ...
            profile_image: '/images/business_avatar.png',
            img_url: '/images/business_avatar.png',
            address: 'Block C, Campus Center',
            opening_time: '08:00',
            closing_time: '18:00',
            opening_status: true,
            auto_accept: false
  ...
  // Function to update canteen profile
  updateCanteenProfile: async (profileData) => {
    try {
        // Ensure the profile data has the correct structure for the API
        ...
        const response = await axios.post(`${API_URL}/canteen/profile/update`, apiProfileData, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${sessionStorage.getItem('auth_token')}`
            }
